...
const LoadingRow = () => (
  <div className="w-full mb-4 h-[60px] text-left bg-gray-100 rounded-2xl animate-pulse"></div>
);
...
const ImportTokenRow = ({
  ...
  <div className="flex justify-between w-full text-left">
    ...
    <button
      className="px-4 bg-blue-500 text-white font-bold hover:bg-blue-400 rounded-2xl text-md"
